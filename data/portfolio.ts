...
export const aboutTexts = [ "I am Pasindu Bhanuka, a tech enthusiastic problem solver who is interested in building useful products and systems for real-world requirements.", 
...
/*
  ...
  */

  {
    ...
    websiteUrl:
      "https://www.youtube.com/playlist?list=PLpWqZTub4k5y-Qm9uUaCUwLiVG7JSEB_7",
    seoKeywords: [
      "Game Development",
...

  {
    ...
    websiteUrl:
      "https://www.youtube.com/playlist?list=PLpWqZTub4k5xgj48ASs9sAUuozIFXc19e",
    seoKeywords: [
      "Sinhala Gaming",
...

  {
    ...
    websiteUrl:
      "https://www.youtube.com/playlist?list=PLpWqZTub4k5w-Sy3N4MJpK6oRsfbmAaEh",
    seoKeywords: [
      "Sinhala Gameplay",
      "Gaming Live Streams",
      "Bhanu Sunrise",
...
export const education: EducationItem[] = [
  {
    ...
    description:
      "Bachelor of Science in Information Technology undergraduate with a focus on Computer Software Engineering. Contributed to academic and non-academic projects involving software development, research, innovation, and community initiatives.",
    fromYear: "2022",
    toYear: "2025",
  },

  {
    ...
    description:
      "Studied Physical Sciences and I.C.T. and completed secondary education at Bandaranayake College Gampaha. Contributed to X'Ban 2018 as a stall organizer and game developer, developing and presenting a video game during the school exhibition.",
    fromYear: "2011",
    toYear: "2019",
  },
];
...
export const certifications: CertificationItem[] = [
  {
    ...
    description:
      "This digital credential validates my knowledge of optimizing MongoDB performance using schema design patterns such as single collection and bucket patterns. It also covers how data models can be improved and effectively scaled across sharded clusters.",
    year: "2025",
  },
...

  {
    ...
    description:
      "This digital credential validates my knowledge of advanced schema design patterns such as approximation and schema versioning. It also covers how schema changes can be managed without downtime and how different antipatterns can impact the overall performance of a database.",
    year: "2025",
  },
...

  {
    ...
    description:
      "This introductory course covers the fundamentals of HTML and how it is used as the core structure of web pages. It also provides a beginner-friendly starting point for front-end web development before moving into other technologies such as CSS and JavaScript.",
    year: "2023",
  },
    ...
    description:
      "This introductory course covers the fundamentals of JavaScript and how it is used to make websites more interactive. It also provides a beginner-friendly introduction to JavaScript programming and how it can be used in modern web development.",
    year: "2023",
  },
...
export const jobExperiences: JobExperienceItem[] = [
  {
    id: "bhanu-sunrise-web-developer",
    organization: "Bhanu Sunrise Solutions",
    position: "Web Developer",
    description:
      "Developed SEO and AEO-friendly websites for different businesses with a focus on improving their online presence and search visibility. Also focused on usability and overall digital experience to make the websites easier for users to find, understand and use.",
    fromYear: "2023",
    toYear: "2026",
  },

  {
    ...
    description:
      "Worked with cross-functional teams to manage digital products and internal technology projects. This experience also helped me improve my skills in team leadership, collaboration, product delivery and developing digital solutions based on user requirements.",
    fromYear: "2025",
    toYear: "2025",
  },

  {
    ...
    description:
      "Completed my internship by leading software engineering activities within the National Development Team of AIESEC in Sri Lanka. Contributed to the development and improvement of internal digital systems while gaining practical experience in software engineering, teamwork and delivering solutions based on organizational requirements.",
    fromYear: "2024",
    toYear: "2025",
  },

  {
    ...
    description:
      "Worked as a member of the National Development Team to develop and upgrade internal systems used by AIESEC in Sri Lanka. This gave me practical experience in working with real-world systems based on the requirements of the organization.",
    fromYear: "2024",
    toYear: "2024",
  },
];
...
export const extraCurriculars: ExtraCurricularItem[] = [
    ...
    description:
      "Contributed to web design activities for AIESEC in Greece, applying web development and user-focused design skills in an international organizational environment.",
    fromYear: "2025",
    toYear: "2025",
  },
  {
    ...
    description:
      "Led product campaign activities within the Creative Regiment of AIESEC in Colombo North.",
    fromYear: "2024",
    toYear: "2025",
  },

  {
    ...
    description:
      "Maintained the event website and facilitated technical requirements for online sessions and the final event.",
    fromYear: "2024",
    toYear: "2024",
  },

  {
    ...
    description:
      "Maintained performance trackers, analyzed member performance, and supported the Local Board and Local Committee Vice Presidents with performance-related activities.",
    fromYear: "2024",
    toYear: "2024",
  },

  {
    ...
    description:
      "Contributed to external relations activities within the Incoming Global Volunteer function of AIESEC in Colombo North.",
    fromYear: "2024",
    toYear: "2024",
  },

  {
    ...
    description:
      "Supported partnership hunting, team discussions, partnership acquisition, and negotiation of partnership packages for NatCon'24.",
    fromYear: "2023",
    toYear: "2024",
  },

  {
    ...
    description:
      "Managed and updated the AIESEC in Colombo North Local Committee Instagram platform.",
    fromYear: "2023",
    toYear: "2024",
  },

  {
    ...
    description:
      "Participated as a member of the Incoming Global Volunteer function at AIESEC in Colombo North.",
    fromYear: "2023",
    toYear: "2024",
  },

  {
    ...
    description:
      "Represented the university in Scrabble activities and competitions. Participated in Fresher's and THE SPELL 2023, played several friendly matches, and achieved 3rd place at the Inter Faculty Scrabble competition.",
    fromYear: "2022",
    toYear: "2024",
  },

  {
    ...
    position: "Member",
    description:
      "Participated in Karate activities at the University of Kelaniya.",
    fromYear: "2022",
    toYear: "2023",
  },

  {
    ...
    description:
      "Handled sponsorship-related responsibilities including creating partnership packages, validating documents, and providing agreed deliverables for the inter-school hackathon.",
    fromYear: "2023",
    toYear: "2023",
  },

  {
    ...
    description:
      "Created YouTube content primarily focused on gaming and technology through the Bhanu Sunrise channel.",
    fromYear: "2020",
    toYear: "2023",
  },

  {
    ...
    description:
      "Developed a video game for X'Ban 2018, the school's major exhibition, and presented the game to visitors while also contributing as a stall organizer.",
    fromYear: "2018",
    toYear: "2018",
  },

  {
    ...
    description:
      "Developed video games as a hobby for more than four years using Game Maker 8.0. Created 2D platformers, racing games, Pacman-style games, pinball-style games, and multiplayer 2D games while also exploring engines such as Godot, Roblox Studio, Unreal Engine, and Construct.",
    fromYear: "2014",
    toYear: "2018",
  },
];
...
export const contacts = [
  { label: "Contact No", value: "+94 76 201 8348", href: "tel:+94762018348" },
  {
    label: "Email",
    value: "pasindubhanuka.dev@gmail.com",
    href: "mailto:pasindubhanuka.dev@gmail.com",
  },
  { label: "GitHub", value: "github.com/bhanusunrise", href: "https://github.com/bhanusunrise" },
  {
    label: "LinkedIn",
    value: "linkedin.com/in/pasindu-bhanuka-",
    href: "https://www.linkedin.com/in/pasindu-bhanuka-",
  },
  { label: "Instagram", value: "@bhanusunrise____", href: "https://www.instagram.com/bhanusunrise____" },
];
